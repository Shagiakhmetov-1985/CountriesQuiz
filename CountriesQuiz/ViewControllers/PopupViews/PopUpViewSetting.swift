//
//  PopUpViewSetting.swift
//  CountriesQuiz
//
//  Created by Marat Shagiakhmetov on 15.11.2023.
//

import UIKit

class PopUpViewSetting: UIView {
    ...
    var delegate: PopUpViewSettingDelegate!
    ...
    @objc private func close() {
        delegate.closeViewSetting()
    }
}

extension PopUpViewSetting {
